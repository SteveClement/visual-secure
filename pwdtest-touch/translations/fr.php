<?php
	...
	$trans["Attaque de type brute-force exécutée sur un PC familial récent utilisant des outils de cassage de mot de passe disponibles gratuitement sur internet."]="Attaque exécutée sur un ordinateur familial récent utilisant des outils de cassage de mot de passe disponibles gratuitement sur Internet.";
	...
	//une phrase
	$trans["Mise en parallèle d'un réseau de"]="Mise en réseau de";
	$trans["ordinateurs zombies au sein d'un même botnet (estimation) pour se répartir la tâche de casser un mot de passe."]="ordinateurs standards contrôlés à distance par une personne malveillante.";
